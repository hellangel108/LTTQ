...
namespace Stelia {
    ...
    public partial class QLBHDataSet1 : global::System.Data.DataSet {
        ...
        public partial class NHANVIENDataTable : global::System.Data.TypedTableBase<NHANVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public NHANVIENRow AddNHANVIENRow(string MANV, string CHUCVU, int SLHD) {
...
namespace Stelia.QLBHDataSet1TableAdapters {
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[NHANVIEN] WHERE (([MANV] = @Original_MANV) AND ((@IsNull_CHUCV" +
                "U = 1 AND [CHUCVU] IS NULL) OR ([CHUCVU] = @Original_CHUCVU)) AND ((@IsNull_SLHD" +
                " = 1 AND [SLHD] IS NULL) OR ([SLHD] = @Original_SLHD)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[NHANVIEN] ([MANV], [CHUCVU], [SLHD]) VALUES (@MANV, @CHUCVU, @" +
                "SLHD);\r\nSELECT MANV, CHUCVU, SLHD FROM NHANVIEN WHERE (MANV = @MANV)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN] SET [MANV] = @MANV, [CHUCVU] = @CHUCVU, [SLHD] = @SLHD WHERE (([MANV] = @Original_MANV) AND ((@IsNull_CHUCVU = 1 AND [CHUCVU] IS NULL) OR ([CHUCVU] = @Original_CHUCVU)) AND ((@IsNull_SLHD = 1 AND [SLHD] IS NULL) OR ([SLHD] = @Original_SLHD)));
SELECT MANV, CHUCVU, SLHD FROM NHANVIEN WHERE (MANV = @MANV)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MANV, CHUCVU, SLHD FROM dbo.NHANVIEN";
        ...
        public virtual int Delete(string Original_MANV, string Original_CHUCVU, global::System.Nullable<int> Original_SLHD) {
            ...
            if ((Original_SLHD.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[4].Value = ((int)(Original_SLHD.Value));
            }
            else {
        ...
        public virtual int Insert(string MANV, string CHUCVU, global::System.Nullable<int> SLHD) {
            if ((MANV == null)) {
            ...
            if ((SLHD.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[2].Value = ((int)(SLHD.Value));
            }
            else {
        ...
        public virtual int Update(string MANV, string CHUCVU, global::System.Nullable<int> SLHD, string Original_MANV, string Original_CHUCVU, global::System.Nullable<int> Original_SLHD) {
            if ((MANV == null)) {
                throw new global::System.ArgumentNullException("MANV");
            }
            else {
            ...
            if ((SLHD.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[2].Value = ((int)(SLHD.Value));
            }
            else {
            ...
            if ((Original_SLHD.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[7].Value = ((int)(Original_SLHD.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CHUCVU, global::System.Nullable<int> SLHD, string Original_MANV, string Original_CHUCVU, global::System.Nullable<int> Original_SLHD) {
            return this.Update(Original_MANV, CHUCVU, SLHD, Original_MANV, Original_CHUCVU, Original_SLHD);
        }
    }
